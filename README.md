ℹ️ You are on a branch with the second version of the `acelot/automapper`. If you want a previous version, then go to [1.x](https://github.com/acelot/automapper/tree/1.x) branch.
